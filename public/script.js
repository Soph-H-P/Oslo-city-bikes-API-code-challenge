...
function onLocationFound(location) {
  ...
  L.circle(location.latlng, radius).addTo(stationMap).bindPopup(`You are here`).openPopup();
}
...
darkModeButton.addEventListener("click", () => {
  let myFilter = ["blur:0px", "brightness:40%", "contrast:130%", "grayscale:80%", "hue:0deg", "opacity:100%", "invert:0%", "saturate:100%", "sepia:10%"];
